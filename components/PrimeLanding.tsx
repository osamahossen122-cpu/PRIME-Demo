  ...
  return (
    <div data-branch="prime" className="min-h-screen bg-[var(--page-bg)] text-[var(--theme-text)]" style={pageTheme}>
      ...
      <main className="relative min-h-screen overflow-hidden">
        <div className="pointer-events-none absolute inset-x-0 top-[5rem] z-20 px-4 sm:top-[5.5rem] sm:px-6 lg:top-[6rem]">
          <div className="mx-auto max-w-lg px-4 py-2 text-center sm:px-5">
            <h1
              lang={locale}
              dir={siteConfig.locales.direction[locale]}
              className="text-3xl font-semibold tracking-[-0.04em] sm:text-5xl lg:text-6xl"
              style={{
                color: mode === "dark" ? "#e2bd7b" : "#b58a36",
                textShadow: mode === "dark"
                  ? "0 0 20px rgba(201,163,93,0.6), 0 0 40px rgba(201,163,93,0.35), 0 0 80px rgba(201,163,93,0.15)"
                  : "0 0 20px rgba(181,138,54,0.5), 0 0 40px rgba(181,138,54,0.25), 0 0 80px rgba(181,138,54,0.1)",
              }}
            >
              {resolveLocaleValue(siteConfig.home.title, locale)}
            </h1>
          </div>
        </div>
